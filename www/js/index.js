    ...
    generateElement: function(type, data, output) {
        ...
        switch(type) {
            ...
            case 'feed':
                ...
                if(data.source.indexOf('twitter') != -1) {
                        ...
                        $.each(data.data, function(key, val) {
                            ...
                            b += '<div';
                            if(val.link) b += ' ontouchend="window.plugins.childBrowser.showWebPage(\'' + val.link + '\');"';
                            b += ' class="ui listitem">';
            ...
            case 'listitem':
                    ...
                    if(data.href) link = ' ontouchend="window.plugins.childBrowser.showWebPage(\'' + data.href + '\')"';
